...
import { useNavigate } from 'react-router-dom'; // 1. Itha mattum pudhusa add pannirukken
import './FeaturedProducts.css';

const FeaturedProducts = () => {
  const navigate = useNavigate(); // 2. Navigate function-a initialize panniyachu
  ...
  const products = [
    ...
    // Pudhusa add panna 4 products
    { id: 7, name: "Aashirvaad Atta 5kg", image: "https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=300&q=80", mrp: 260, price: 220, discount: "15% OFF", rating: 4.6, reviews: 415 },
    { id: 8, name: "Tata Salt 1kg", image: "https://www.bbassets.com/media/uploads/p/l/241600_9-tata-salt-iodized.jpg", mrp: 28, price: 25, discount: "10% OFF", rating: 4.9, reviews: 850 },
    { id: 9, name: "Red Label Tea 500g", image: "https://images.unsplash.com/photo-1597481499750-3e6b22637e12?auto=format&fit=crop&w=300&q=80", mrp: 250, price: 210, discount: "16% OFF", rating: 4.7, reviews: 320 },
    { id: 10, name: "Maggi Noodles 400g", image: "https://www.bbassets.com/media/uploads/p/l/20005893_3-maggi-noodles-masala.jpg", mrp: 96, price: 85, discount: "11% OFF", rating: 4.5, reviews: 560 }
  ];
  ...
  return (
    <section className="featured-section">
      <div className="section-header">
        ...
        {/* 3. Button-la click event add panniyachu */}
        <button 
          className="view-all-outline" 
          onClick={() => navigate('/offer-products')}
        >
          View All Products
        </button>
      </div>
